        ...
        <div class="row">
            ...
            <div class="col mt-5" style="height: 1024px;">
                <form method="POST" action="{{route('register')}}" class="needs-validation"
                    novalidate oninput='inputConfirmPassword.setCustomValidity(inputConfirmPassword.value != inputPassword.value ? true : "")'>
                    @csrf
                    <div class="mx-5 d-grid gap-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="inputNama" required>
                            <div class="invalid-feedback" role="alert">
                                Mohon masukan nama Anda dengan benar!
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputPassword">Password</label>
                            <input type="password" name="password" class="form-control" id="inputPassword" required pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$">
                            <div class="invalid-feedback" role="alert">
                        ...
                        <p class="fw-light fs-6 text-center">Sudah mempunyai akun? <a href="login"
